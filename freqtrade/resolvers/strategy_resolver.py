...
class StrategyResolver(IResolver):
    ...
    @staticmethod
    def load_strategy(config: Dict[str, Any] = None, regr: Any = None) -> IStrategy:
        """
        ...
        strategy: IStrategy = StrategyResolver._load_strategy(
            ...
            extra_dir=config.get('strategy_path'), regr=regr)
    ...
    def _load_strategy(strategy_name: str,
                       config: dict, extra_dir: Optional[str] = None, regr: Any = None) -> IStrategy:
        """
        ...
        strategy = StrategyResolver._load_object(paths=abs_paths,
                                                 ...
                                                 kwargs={'config': config, 'regr': regr})
        if strategy:
